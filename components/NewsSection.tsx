...
export const NewsSection: React.FC<NewsSectionProps> = ({ onSelectNews, onOpenAllNews }) => {
  ...
  // Memisahkan Berita Utama (index 0, yang otomatis naik jika di-pin di CMS Cration) dan Berita Lainnya (index 1 s.d 4)
            ...
            {featuredNews && (
              ...
              >
                ...
                <div className="p-6 sm:p-8 flex-1 flex flex-col justify-between bg-white relative z-10">
                  ...
                  <div>
                    <button className="bg-[#073922] hover:bg-[#0a4b2f] text-[#e5a93c] font-semibold text-xs sm:text-sm px-6 py-3 rounded-lg shadow-xs transition-all flex items-center gap-2 group-hover:gap-3">
