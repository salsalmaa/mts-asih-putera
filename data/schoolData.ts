...
// Menggunakan path string langsung dari folder public/images
const imgTahfidzQuran = "/images/prog_tahfidz_adab_new.jpg";
const imgProjectLearning = "/images/prog_pbl_new.jpg";
const imgPublicSpeaking = "/images/prog_riset_speaking_new.jpg";
const imgBabaktiSepuh = "/images/prog_babakti_sepuh_new.jpg";
const imgCitySurvival = "/images/prog_city_survival_new.jpg";
const imgLeadershipCamp = "/images/prog_leadership_camp_new.jpg";
const imgProgOlympiad = "/images/prog_olympiad_sains_new.jpg";
const imgProgTahfidzMtq = "/images/prog_tahfidz_mtq_new.jpg";
const imgProgScienceInnovation = "/images/prog_science_innovation_new.jpg";
const imgProgSocialService = "/images/prog_social_service_new.jpg";
const imgProgArtsCulture = "/images/prog_arts_culture_new.jpg";
const imgWhyTauhid = "/images/why_tauhid_new.jpg";
const imgWhyAkademik = "/images/why_akademik_new.jpg";
const imgWhyKarakter = "/images/why_karakter_new.jpg";
const imgWhyLingkungan = "/images/why_lingkungan_new.jpg";
const imgJourneyKelas7 = "/images/journey_kelas7_new.jpg";
const imgJourneyKelas8 = "/images/journey_kelas8_new.jpg";
const imgJourneyKelas9 = "/images/journey_kelas9_new.jpg";
const imgNewsOpenHouse = "/images/news_openhouse_new.jpg";
const imgNewsMilad = "/images/news_milad_new.png";
const imgNewsLeadership = "/images/news_leadership_new.jpg";
const imgFacilityClassroom = "/images/fac_kelas_new.jpg";
const imgFacilityLibrary = "/images/fac_perpus_new.jpg";
const imgFacilityLab = "/images/fac_lab_new.jpg";
const imgFacilityMosque = "/images/fac_masjid_new.jpg";
const imgFacilitySports = "/images/fac_olahraga_new.jpg";
const imgFacilityCreativity = "/images/fac_kreativitas_new.jpg";
const imgAvatarBapakFajar = "/images/bapak_fajar_testimonial_1787396774116.jpg";
const imgAvatarIbuRina = "/images/ibu_rina_testimonial_1787396789356.jpg";
const imgAvatarRaihan = "/images/raihan_siswa_mts_1787396803996.jpg";
...
export const WHY_US_DATA: WhyUsItem[] = [
  {
    ...
    description:
      "Menanamkan nilai tauhid dan adab sebagai fondasi berpikir, bersikap, dan bertindak.",
    iconName: "BookOpen",
  ...
  },
  {
    ...
    description:
      "Pembelajaran bermakna yang mengembangkan kemampuan berpikir kritis, kreatif, dan literat.",
  ...
  },
  {
    ...
    description:
      "Pembinaan menyeluruh untuk membentuk karakter tangguh, mandiri, dan bertanggung jawab.",
    iconName: "Users2",
  ...
  },
  {
    ...
    description:
      "Lingkungan belajar yang aman, nyaman, dan mendukung tumbuh kembang remaja.",
    iconName: "GraduationCap",
    tag: "CAMPUS LIFE",
...
export const OUTCOMES_DATA: OutcomeItem[] = [
  {
    ...
    title: "Iman & Akhlak",
    description:
      "Remaja beriman kuat dan berakhlak mulia dalam kehidupan sehari-hari.",
    iconName: "Sparkles",
  },
  {
    id: "nalar-prestasi",
  ...
  },
  {
    ...
    description:
      "Remaja berkarya nyata dan memberi manfaat bagi lingkungan dan masyarakat.",
    iconName: "Leaf",
  },
];
...
export const JOURNEY_STAGES: JourneyStage[] = [
  {
    ...
    description:
      "Fase transisi penting yang berfokus pada penanaman adab, adaptasi ritme belajar madrasah, kedisiplinan ibadah mandiri, serta penguatan literasi dasar.",
  },
  {
    grade: "2",
    title: "Kelas 8",
...
export const ALL_PROGRAMS_DATA: ProgramItem[] = [
  {
    ...
    description:
      "Bimbingan intensif menghafal Al-Qur'an dengan metode talaqqi bersanad, perbaikan makharijul huruf, dan penjiwaan adab Qurani dalam keseharian siswa.",
    highlights: [
    ...
    outcomes:
      "Siswa memiliki hafalan mutqin, bacaan tartil berkaidah tajwid, dan perilaku beradab.",
  },
  {
    id: "pbl",
    ...
    description:
      "Metode pembelajaran kontekstual di mana siswa memecahkan persoalan dunia nyata melalui riset, prototipe rekayasa, dan presentasi terbuka.",
    highlights: [
    ...
    outcomes:
      "Siswa mampu menghasilkan karya inovatif yang solutif dan teruji.",
  },
  {
    id: "riset-speaking",
    ...
    description:
      "Program akselerasi kemampuan bernalar kritis, penulisan karya tulis ilmiah remaja, debat argumen, dan kepercayaan diri berbicara di podium publik.",
    highlights: [
    ...
    outcomes:
      "Siswa percaya diri tampil di panggung publik dan cakap berargumen secara santun dan ilmiah.",
  },
  {
    id: "babakti-sepuh",
    ...
    description:
      "Program kultural berbasis nilai luhur Sunda-Islami untuk menanamkan rasa hormat, khidmah, bakti, dan kehangatan hubungan anak kepada orang tua.",
    highlights: [
    ...
    outcomes:
      "Remaja yang berhati lembut, taat kepada orang tua, dan menjunjung adab timur.",
  },
  {
    id: "city-survival",
    ...
    description:
      "Tantangan petualangan edukatif di ruang publik kota tanpa gawai pribadi, di mana siswa mengelola anggaran minim, transportasi umum, dan navigasi tim.",
    highlights: [
    ...
    outcomes:
      "Remaja yang tanggap situasi, mandiri, tidak mudah panik, dan piawai berkomunikasi.",
  },
  {
    id: "leadership-camp",
    ...
    description:
      "Kemah kepemimpinan di alam terbuka untuk memupuk kebersamaan ukhuwah, kepedulian lingkungan, mental juang, dan kepemimpinan visioner.",
    highlights: [
    ...
    outcomes:
      "Jiwa kepemimpinan yang berintegritas, tahan uji, dan berjiwa sosial tinggi.",
  },
  {
    id: "olympiad-sains",
    ...
    description:
      "Bimbingan intensif persiapan kompetisi sains madrasah (KSM), olimpiade sains nasional (OSN), dan kejuaraan matematika-IPA terpadu dengan pendampingan pakar.",
    highlights: [
    ...
    outcomes:
      "Siswa memiliki daya nalar tinggi dan siap bersaing meraih medali kejuaraan sains tingkat kota, provinsi, hingga nasional.",
  },
  {
    id: "tahfidz-mtq",
    title: "Tahfidz & MTQ",
    ...
    description:
      "Pengembangan seni baca Al-Qur'an bertajwid indah (Musabaqah Tilawatil Qur'an) serta halaqah muraja'ah mendalam dan penguatan hafalan tartil.",
    highlights: [
    ...
    outcomes:
      "Mencetak qari dan hafizah remaja yang fasih, berjiwa Qur'ani, dan berprestasi dalam ajang MTQ.",
  },
  {
    ...
    description:
      "Wadah eksperimen rekayasa terapan, robotika sederhana, teknologi tepat guna, dan karya ilmiah remaja untuk melatih jiwa inventor muda.",
    highlights: [
    ...
    outcomes:
      "Siswa terampil merancang prototipe inovatif dan berpikir solutif terhadap permasalahan sains teknologi.",
  },
  {
    id: "social-service",
    ...
    description:
      "Aksi nyata kerelawanan, bakti sosial kemasyarakatan, kepanduan Pramuka peduli lingkungan, dan donasi kemanusiaan untuk memupuk empati sosial.",
    highlights: [
    ...
    outcomes:
      "Remaja yang peka terhadap kondisi sosial sekitar, gemar menolong, dan memiliki jiwa kepemimpinan sosial.",
  },
  {
    id: "arts-culture",
    ...
    description:
      "Apresiasi seni rupa Islam, kaligrafi khat, musik islami/marawis/nasyid, seni budaya Sunda, serta kejuaraan minat bakat siswa.",
    highlights: [
    ...
    outcomes:
      "Siswa memiliki kehalusan budi, kecintaan pada warisan budaya islami & daerah, serta penghargaan prestasi seni.",
  },
];
...
export const FACILITIES_DATA: FacilityItem[] = [
  {
    ...
    description:
      "Ruang kelas ber-AC dengan pencahayaan alami optimal, proyektor interaktif, dan layout meja modular yang mendukung diskusi kolaboratif.",
    capacity: "24-28 Siswa per kelas",
    features: [
      "AC & Sirkulasi Segar",
      "Smart Projector / Display",
      "Ergonomic Desk & Chair",
      "Locker Pribadi Siswa",
    ],
  },
  {
    id: "perpustakaan",
    ...
    description:
      "Pusat sumber belajar lengkap dengan ribuan koleksi buku referensi, novel sastra pilihan, ensiklopedia Islam, dan corner e-library digital.",
    capacity: "60 Siswa",
    features: [
      "Koleksi 5.000+ Buku",
      "Akses E-Book & Jurnal",
  ...
  },
  {
    ...
    description:
      "Laboratorium IPA terpadu (Fisika, Biologi, Kimia) dan Lab Komputer modern untuk riset sains, coding, dan pengolahan data digital.",
    capacity: "32 Siswa",
    features: [
      "Mikroskop Digital & Alat Lab Standar",
      "PC High-Spec & Internet Cepat",
      "Safety Equipment Lengkap",
      "Bahan Eksperimen Terjamin",
    ],
  },
  {
    id: "masjid",
    ...
    description:
      "Masjid megah dan bersih yang menjadi jantung kegiatan spiritual, tempat shalat berjamaah, halaqah Al-Qur'an, dan pembinaan karakter ruhani.",
    capacity: "500+ Jamaah",
    features: [
      "Karpet Berkualitas & Bersih",
      "Sound System Jernih",
      "Tempat Wudhu Nyaman",
      "Ruang Halaqah Khusus",
    ],
  },
  {
    id: "olahraga",
    ...
    description:
      "Fasilitas olahraga multifungsi untuk basket, futsal, bulu tangkis, voli, dan panahan guna menjaga kebugaran dan sportivitas siswa.",
    capacity: "2 Lapangan Terpadu",
    features: [
      "Lapangan Basket & Futsal Vinyl",
      "Area Memanah Standard",
  ...
  },
  {
    ...
    description:
      "Wadah bagi OSIS, ekstrakurikuler seni musik, robotik, teater, jurnalistik, dan karya kreatif untuk mengeksplorasi minat dan bakat remaja.",
    capacity: "40 Siswa",
    features: [
      "Alat Musik & Sound Editing",
      "Perlengkapan Robotik & Arduino",
      "Papan Strategi & Brainstorming",
      "Pojok Karya Seni",
    ],
  },
];
...
export const TESTIMONIALS_DATA: TestimonialItem[] = [
  {
    ...
    quote:
      "Kurikulum yang memadukan nilai agama dan akademik di MTs Asih Putera sangat membantu anak saya tumbuh menjadi pribadi yang santun namun tetap kritis dalam berpikir.",
  ...
  },
  {
    ...
    role: "ORANG TUA SISWA",
    quote:
      "Saya sangat mengapresiasi program pembiasaan adab dan tahfidz harian. Lingkungannya sangat positif dan mendukung perkembangan karakter remaja.",
  ...
  },
  {
    ...
    role: "SISWA KELAS 9",
    quote:
      "Belajar di sini seru banget karena banyak proyek lapangan dan kegiatan leadership. Saya jadi lebih percaya diri untuk berbicara di depan umum.",
...
export const NEWS_DATA: NewsItem[] = [
  {
    ...
    excerpt:
      "Kunjungi sekolah dan temukan pengalaman belajar terbaik untuk buah hati Anda. Sesi trial class, konsultasi kurikulum, dan beasiswa prestasi.",
  ...
  },
  {
    ...
    excerpt:
      "Merayakan kebersamaan, prestasi, dan kontribusi untuk melangkah lebih maju dalam membina generasi rabbani berwawasan global.",
    image: imgNewsMilad,
    category: "Peringatan & Seni",
    fullContent:
      "Rangkaian perayaan milad MTs Asih Putera dimeriahkan dengan pagelaran seni budaya Sunda-Islami, expo proyek inovasi siswa, penyerahan penghargaan kepada siswa dan guru berprestasi, serta tabligh akbar dan santunan kaum dhuafa.",
  },
  {
    id: "leadership-day",
    date: "03 MEI 2026",
    ...
    excerpt:
      "Belajar memimpin, bekerja sama, dan menikmati alam dalam ekspedisi kepemimpinan di kaki Gunung Tangkuban Parahu.",
