...
async function handleGallery(request: NextRequest) {
  try {
    ...
    console.log("📤 Fetching Gallery data dengan token menggunakan Axios...");
    ...
    // Menggunakan Axios untuk melakukan GET request ke backend endpoint gallery
    ...
    console.error("❌ Gallery API Route Error:", error);
