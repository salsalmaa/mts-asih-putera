...
import imgKemitraanOrtu from '../assets/images/mts_kemitraan_ortu_1787397799431.jpg';
import imgSistemMutu from '../assets/images/mts_sistem_mutu_1787397822611.jpg';
              ...
              <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  ...
                  >
                    ...
                    <circle cx="35" cy="35" r="16" stroke="currentColor" strokeWidth="1.2" fill="none" />
                    <circle cx="35" cy="35" r="11" stroke="currentColor" strokeWidth="0.8" strokeDasharray="2 2" fill="none" />
                    ...
                    {/* Corner Rosettes */}
                    <circle cx="0" cy="0" r="8" stroke="currentColor" strokeWidth="1" fill="none" />
                    <circle cx="70" cy="0" r="8" stroke="currentColor" strokeWidth="1" fill="none" />
                    <circle cx="0" cy="70" r="8" stroke="currentColor" strokeWidth="1" fill="none" />
                    <circle cx="70" cy="70" r="8" stroke="currentColor" strokeWidth="1" fill="none" />
                    <line x1="0" y1="0" x2="70" y2="70" stroke="currentColor" strokeWidth="0.8" strokeDasharray="3 3" />
                    <line x1="70" y1="0" x2="0" y2="70" stroke="currentColor" strokeWidth="0.8" strokeDasharray="3 3" />
                  </pattern>
                </defs>
                <rect width="100%" height="100%" fill="url(#dense-intricate-islamic-kemitraan)" />
              </svg>
            </div>
            ...
            <div className="flex-1 relative z-10">
              ...
              <ul className="space-y-2.5 text-xs sm:text-[13px] text-emerald-100/95 group-hover:text-white transition-colors">
                <li className="flex items-start gap-2.5">
                  ...
                  <span className="leading-snug">Komunikasi intensif & transparan</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#e5a93c] shrink-0 mt-0.5" />
                  <span className="leading-snug">Laporan perkembangan belajar</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#e5a93c] shrink-0 mt-0.5" />
                  <span className="leading-snug">Mentoring & pembinaan karakter</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#e5a93c] shrink-0 mt-0.5" />
                  <span className="leading-snug">Sesi parenting & edukasi rutin</span>
                </li>
              </ul>
            </div>
          ...
          <div className="relative lg:col-span-5 bg-[#06331e] hover:bg-[#084227] border border-[#16603b] hover:border-[#e5a93c] rounded-2xl p-6 sm:p-7 shadow-md hover:shadow-2xl hover:shadow-[0_16px_36px_rgba(4,36,22,0.4)] transition-all duration-300 hover:-translate-y-1 flex flex-col sm:flex-row gap-5 items-center overflow-hidden group cursor-pointer">
              ...
              <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  ...
                  >
                    ...
                    <polygon points="35,16 45,35 35,54 25,35" stroke="currentColor" strokeWidth="0.9" fill="none" />
                ...
                <rect width="100%" height="100%" fill="url(#dense-intricate-islamic-sistem-mutu)" />
              </svg>
            </div>
            ...
            <div className="flex-1 relative z-10">
              ...
              <ul className="space-y-2.5 text-xs sm:text-[13px] text-emerald-100/95 group-hover:text-white transition-colors">
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#e5a93c] shrink-0 mt-0.5" />
                  <span className="leading-snug">Perencanaan pembelajaran terukur</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#e5a93c] shrink-0 mt-0.5" />
                  <span className="leading-snug">Observasi & supervisi berkelanjutan</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#e5a93c] shrink-0 mt-0.5" />
                  <span className="leading-snug">Penilaian autentik & komprehensif</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#e5a93c] shrink-0 mt-0.5" />
                  <span className="leading-snug">Monitoring & pengembangan berkelanjutan</span>
                </li>
              </ul>
            </div>
