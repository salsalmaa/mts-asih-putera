  ...
  return (
    <section id="program" className="w-full py-16 sm:py-24 bg-[#faf9f5] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
        ...
        {/* Layout: Left Highlights Card + Right 6 Programs Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch mb-10">
          ...
          {/* Right 6 Program Cards Grid (8 cols) */}
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4.5">
