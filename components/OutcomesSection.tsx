...
export const OutcomesSection: React.FC = () => {
        ...
        return (
          <div className="relative w-8 h-8 flex items-center justify-center">
            <svg viewBox="0 0 36 36" className="w-8 h-8" fill="none">
              ...
              <rect x="15" y="13" width="6" height="6" stroke="#e5a93c" strokeWidth="1.2" fill="#083e24" />
              <rect x="15" y="13" width="6" height="6" transform="rotate(45 18 16)" stroke="#e5a93c" strokeWidth="1.2" fill="#083e24" />
            </svg>
          </div>
        );
      ...
      case 'out-3':
        ...
        return (
          <div className="relative w-8 h-8 flex items-center justify-center">
            <svg viewBox="0 0 36 36" className="w-8 h-8" fill="none">
              {/* Outer compass ring */}
              <circle cx="18" cy="18" r="13" stroke="#ffffff" strokeWidth="1.4" fill="#083e24" fillOpacity="0.8" />
  ...
  return (
    <section className="relative w-full py-16 sm:py-20 bg-[#fdfcf9] border-t border-[#ece7d8] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <p className="text-[12px] sm:text-xs font-semibold tracking-widest uppercase text-[#9c7428] mb-1.5 font-sans">
          ...
          <IslamicOrnamentalDivider className="my-3 sm:my-3.5" color="#0a4b2f" />

          <p className="text-gray-600 text-xs sm:text-sm max-w-2xl mx-auto leading-relaxed mt-1">
        ...
        {/* 4 Cards Grid - Styled exclusively with MTs Asih Putera signature Deep-Green Theme & Islamic Patterns */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {OUTCOMES_DATA.map((item) => (
            <div
              key={item.id}
              className="relative overflow-hidden bg-[#06331e] hover:bg-[#084227] rounded-2xl p-6 sm:p-7 border border-[#16603b] hover:border-[#e5a93c]/80 shadow-md hover:shadow-2xl hover:shadow-[0_12px_32px_rgba(4,36,22,0.35)] transition-all duration-300 hover:-translate-y-1 flex flex-col group text-center sm:text-left cursor-pointer"
            >
              ...
              {/* Subtle background Islamic geometric/floral pattern inside each deep-green card */}
              <div 
              ...
              <div className="w-14 h-14 rounded-2xl bg-[#083e24] border border-[#1d6b43] group-hover:border-[#e5a93c] flex items-center justify-center mb-5 mx-auto sm:mx-0 shadow-md group-hover:scale-110 group-hover:shadow-[0_0_16px_rgba(229,169,60,0.35)] transition-all duration-300 relative z-10">
              ...
              <p className="text-emerald-100/90 group-hover:text-white text-xs sm:text-[13px] leading-relaxed relative z-10 transition-colors">
                {item.description}
              </p>

              {/* Bottom Subtle Gold Accent Bar */}
              <div className="mt-auto pt-4 border-t border-[#155a37] flex items-center justify-between opacity-80 group-hover:opacity-100 transition-opacity text-[11px] font-semibold text-[#e5a93c] relative z-10">
